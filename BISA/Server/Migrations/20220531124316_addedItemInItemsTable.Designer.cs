...
namespace BISA.Server.Migrations
{
    ...
    [Migration("20220531124316_addedItemInItemsTable")]
    partial class addedItemInItemsTable
    {
            ...
            modelBuilder.Entity("BISA.Shared.Entities.LoanEntity", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            Date_From = new DateTime(2022, 5, 31, 14, 43, 15, 797, DateTimeKind.Local).AddTicks(5280),
                            Date_To = new DateTime(2022, 6, 20, 14, 43, 15, 797, DateTimeKind.Local).AddTicks(5318),
                            ItemInventoryId = 1,
                            UserId = 2
                        },
                        new
                        {
                            Id = 2,
                            Date_From = new DateTime(2022, 5, 31, 14, 43, 15, 797, DateTimeKind.Local).AddTicks(5322),
                            Date_To = new DateTime(2022, 6, 20, 14, 43, 15, 797, DateTimeKind.Local).AddTicks(5324),
                            ItemInventoryId = 2,
                            UserId = 5
                        },
                        new
                        {
                            Id = 3,
                            Date_From = new DateTime(2022, 5, 31, 14, 43, 15, 797, DateTimeKind.Local).AddTicks(5327),
                            Date_To = new DateTime(2022, 6, 7, 14, 43, 15, 797, DateTimeKind.Local).AddTicks(5329),
                            ItemInventoryId = 4,
                            UserId = 3
                        },
                        new
                        {
                            Id = 4,
                            Date_From = new DateTime(2022, 5, 31, 14, 43, 15, 797, DateTimeKind.Local).AddTicks(5333),
                            Date_To = new DateTime(2022, 6, 20, 14, 43, 15, 797, DateTimeKind.Local).AddTicks(5335),
                            ItemInventoryId = 6,
                            UserId = 5
                        },
                        new
                        {
                            Id = 5,
                            Date_From = new DateTime(2022, 5, 31, 14, 43, 15, 797, DateTimeKind.Local).AddTicks(5337),
                            Date_To = new DateTime(2022, 6, 7, 14, 43, 15, 797, DateTimeKind.Local).AddTicks(5340),
                            ItemInventoryId = 18,
                            UserId = 5
                        },
                        new
                        {
                            Id = 6,
                            Date_From = new DateTime(2022, 5, 31, 14, 43, 15, 797, DateTimeKind.Local).AddTicks(5342),
                            Date_To = new DateTime(2022, 6, 7, 14, 43, 15, 797, DateTimeKind.Local).AddTicks(5344),
                            ItemInventoryId = 15,
                            UserId = 5
                        },
                        new
                        {
                            Id = 7,
                            Date_From = new DateTime(2022, 5, 31, 14, 43, 15, 797, DateTimeKind.Local).AddTicks(5347),
                            Date_To = new DateTime(2022, 6, 20, 14, 43, 15, 797, DateTimeKind.Local).AddTicks(5349),
                            ItemInventoryId = 14,
                            UserId = 5
                        });
                });
            ...
            modelBuilder.Entity("BISA.Shared.Entities.LoanReservationEntity", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            Date_From = new DateTime(2022, 5, 31, 14, 43, 15, 797, DateTimeKind.Local).AddTicks(5400),
                            Date_To = new DateTime(2022, 6, 20, 14, 43, 15, 797, DateTimeKind.Local).AddTicks(5402),
                            ItemId = 1,
                            UserId = 3
                        },
                        new
                        {
                            Id = 2,
                            Date_From = new DateTime(2022, 5, 31, 14, 43, 15, 797, DateTimeKind.Local).AddTicks(5405),
                            Date_To = new DateTime(2022, 6, 20, 14, 43, 15, 797, DateTimeKind.Local).AddTicks(5408),
                            ItemId = 1,
                            UserId = 4
                        },
                        new
                        {
                            Id = 4,
                            Date_From = new DateTime(2022, 5, 31, 14, 43, 15, 797, DateTimeKind.Local).AddTicks(5410),
                            Date_To = new DateTime(2022, 6, 7, 14, 43, 15, 797, DateTimeKind.Local).AddTicks(5413),
                            ItemId = 9,
                            UserId = 1
                        },
                        new
                        {
                            Id = 5,
                            Date_From = new DateTime(2022, 6, 20, 14, 43, 15, 797, DateTimeKind.Local).AddTicks(5415),
                            Date_To = new DateTime(2022, 6, 27, 14, 43, 15, 797, DateTimeKind.Local).AddTicks(5417),
                            ItemId = 9,
                            UserId = 3
                        });
                });
